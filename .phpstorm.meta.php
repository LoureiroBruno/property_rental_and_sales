...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./application/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./application/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.http_only','session.same_site','session.partitioned','concurrency.default','broadcasting.default',
