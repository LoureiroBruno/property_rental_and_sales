  ...
  <header
    ...
    <div class="container mx-auto">
      <nav class="p-4 flex flex-wrap items-center justify-between gap-4 md:flex-nowrap">
        ...
        <!-- Menu Esquerdo (visível se usuário autenticado) -->
        <div v-if="user">
        ...
        <div v-if="user" class="relative flex items-center gap-6">
          <div id="user-menu" class="relative">
            ...
            <!-- Dropdown Menu -->
            <div v-if="open"
              class="absolute right-0 mt-2 w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-50 overflow-hidden">
