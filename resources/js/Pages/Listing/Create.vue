    ...
    <form @submit.prevent="create">
        <div class="grid grid-cols-6 gap-4">
            ...
            <div class="col-span-6 flex gap-2">
                <button type="submit"
                    class="bg-indigo-600 hover:bg-indigo-500 text-white font-medium p-2 rounded-md flex items-center gap-1">
                    <PlusIcon class="w-5 h-5" />
                    Create
                </button>
                <Link :href="route('listing.index')" class="flex items-center gap-1">
                <a class="bg-gray-600 hover:bg-gray-500 text-white font-medium p-2 rounded-md flex items-center gap-1">
