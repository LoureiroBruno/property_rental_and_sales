        ...
        <Box v-for="listing in listings" :key="listing.id">
            ...
            <!-- <div class="mt-4 flex gap-2">
                <Link :href="route('listing.edit', { listing: listing.id })"
                    class="px-4 py-1 text-sm bg-blue-500 text-white rounded hover:bg-blue-800 transition">
                Editar
                </Link>

                <Link :href="route('listing.destroy', { listing: listing.id })" method="DELETE" as="button"
                    class="px-2 py-1 text-sm bg-red-500 text-white rounded hover:bg-red-800 transition">
                Deletar
                </Link>
            </div> -->
