<template>
    <Box v-if="!offerMade">
        ...
        <div>
            <form @submit.prevent="makeOffer">
                ...
                <input v-model.number="form.amount" type="range" :min="price / 2" :max="price * 2" step="1000"
    ...
    <Box v-else>
        ...
        <section class="mt-1 flex flex-col md:flex-row justify-between text-gray-500">
            <div>Made on</div>
